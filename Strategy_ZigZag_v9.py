...
class Strategy (TraderStrategy):
    ...
    def plot(self,ops,buy_index,sell_index):
        ...
        self.tp.plot_check_previous(ops["g_pmoline"],'red','red')
        self.tp.plot_check_previous(ops["g_pmosignalline"],'red','red')
        self.tp.plot_check_previous(ops["std_pmoline"],'purple','purple')
        self.tp.plot_check_previous(ops["std_pmosignalline"],'purple','purple')
        self.tp.fill(ops["g_pmohistogram"],0,'red','green')
 
        
        self.tp.plot_check_previous(ops['main_dtlclose'],'black','black')

        self.tp.plot_check_previous(ops['pp_kama6ema'],'blue','orange')
        
        
        self.tp.plot(ops['d_std'],'cyan')
    ...
    def plot_sell(self,ops,index,size):
        ...
        self.tp.plot_check_previous(ops["g_pmoline"][st:en],'red','red')
        self.tp.plot_check_previous(ops["g_pmosignalline"][st:en],'red','red')
        self.tp.plot_check_previous(ops["std_pmoline"][st:en],'purple','purple')
        self.tp.plot_check_previous(ops["std_pmosignalline"][st:en],'purple','purple')
        self.tp.fill(ops["g_pmohistogram"][st:en],0,'red','green')
        self.tp.plot_check_previous(ops['main_dtlclose'][st:en],'black','black')
        self.tp.plot_check_previous(ops['pp_kama6ema'][st:en],'blue','orange')
        self.tp.plot(ops['d_std'][st:en],'cyan')
        self.tp.plot(ops['pp_ema64'][st:en],'purple')
        self.tp.h_line(0,'black','-')
        self.tp.show()
    ...
    def buy(self,ops,index):
        ...
        '''
        '''
        if(ops["slp"][index]-ops["slp"][index-1]>0 and ops["slp"][index]>0 and diff_add ==6):
            if(   ops["slp"][index-1]-ops["slp"][index-2]<0 
               or ops["slp"][index-2]-ops["slp"][index-3]<0
               or ops["slp"][index-3]-ops["slp"][index-4]<0
               or ops["slp"][index-4]-ops["slp"][index-5]<0):
                return True
            
        if(ops["slp"][index]-ops["slp"][index-1]>0 and ops["slp"][index]<0 and ops["main_dtlclose"][index]>ops['pp_ema64'][index] ):
            return True
        '''
        
        '''
        if((ops["slp"][index]-ops["slp"][index-1]>0 and ops["g_pmosignalline"][index]-ops["g_pmosignalline"][index-1]>0 and ops["main_dtlclose"][index]>ops['pp_ema64'][index])):
            return True
        '''
        '''
        if(ops["main_dtlclose"][index-1]<ops['pp_ema64'][index-1]):
            return False
        if(ops["main_dtlclose"][index-2]<ops['pp_ema64'][index-2]):
            return False
        '''
        
        
        '''
        if( ops["g_pmosignalline"][index]-ops["g_pmosignalline"][index-1]>0 
        ...
        if(ops["g_pmohistogram"][index]>ops["g_pmohistogram"][index-1] 
           and ops["g_pmohistogram"][index-1]>ops["g_pmohistogram"][index-2] 
           and ops["g_pmoline"][index]> ops["g_pmoline"][index-1]
           and ops["g_pmoline"][index-1]> ops["g_pmoline"][index-2]):
            return True
        '''
        
        
        if(
            ops['pp_kama6ema'][index]<ops['pp_kama6ema'][index-1]
            and ops['pp_ema64'][index]<ops['pp_ema64'][index-1]
            and ops["main_dtlclose"][index]<ops['pp_kama6ema'][index] 
            and ops["main_dtlclose"][index]<ops['pp_ema64'][index] 
        ):
            return False
        ...
        if(
            (ops['pp_kama6ema'][index]<ops['pp_kama6ema'][index-1]
            or ops['pp_ema64'][index]<ops['pp_ema64'][index-1])
            
            and 
            (ops["main_dtlclose"][index]<ops['pp_kama6ema'][index] 
            or ops["main_dtlclose"][index]<ops['pp_ema64'][index])
        ...
        if(ops['g_pmohistogram'][index]>ops['g_pmohistogram'][index-1]
        and ops["g_pmoline"][index]> ops["g_pmoline"][index-1]
        and ops["std_pmoline"][index]>ops['g_pmoline'][index-1]
        ):
