...
class Strategy (TraderStrategy):
    ...
    def plot(self,ops,buy_index,sell_index):
        ...
        #self.tp.plot_check_previous(ops['pp_ema8'],'green','red')
        #self.tp.plot_check_previous(ops['pp_ema15'],'green','red')
        #self.tp.plot_check_previous(ops['pp_ema34'],'green','red')
        #self.tp.plot_check_previous(ops['pp_ema50'],'green','red')
        #self.tp.plot_check_previous(ops['pp_ema64'],'green','red')
        #self.tp.plot_check_previous(ops['pp_add'],'green','red')
        #self.tp.plot_check_previous(ops['pp_kama'],'blue','orange')
        #self.tp.plot_check_previous(ops['rsi']/100,'blue','blue') 
        ...
        for i in range(1,len(ops["zzimperbuy"])):
            if(ops["zzimperbuy"][i]>-1):
                if((not (ops["zzimperbuy"][i] == ops["zzimperbuy"][i-1])) and ops["zzimperbuy"][i]==1):
    ...
    def buy(self,ops,index):
        ...
        buy = False
        if(ops["zzimperbuy"][index-1][1]==0 and ops["zzimperbuy"][index][1] == 1):          
            buy = True
