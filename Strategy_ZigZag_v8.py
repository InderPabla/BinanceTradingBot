...
class Strategy (TraderStrategy):
    ...
    def plot(self,ops,buy_index,sell_index):
        ...
        self.tp.plot_check_previous(ops['slpmd'],'blue','cyan')
        self.tp.plot_check_previous(ops['slphs'],'green','red')
        self.tp.plot_check_previous(ops['sub'],'orange','orange')
    ...
    def buy(self,ops,index):
        ...
        if(ops['sub'][index]<0.1):
            if(ops['slpmd'][index]>0 ):
                return True
    ...
    def sell(self,ops,index,buy_index):
        ...
        if(ops['sub'][index]-ops['sub'][index-1]<0):
            return True
        return False
