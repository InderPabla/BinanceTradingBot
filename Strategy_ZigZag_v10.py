...
class Strategy (TraderStrategy):
    ...
    def run_strategy(self):
        ...
        ops["pp_30sma"] = hkdtl.SMA(hkdtl.close,30*3,strip = True)
        ops["pp_50sma"] = hkdtl.SMA(hkdtl.close,50*3,strip = True)
        ops["pp_100sma"] = hkdtl.SMA(hkdtl.close,100*3,strip = True)
    ...
    def plot(self,ops,buy_index,sell_index):
        ...
        self.tp.plot_check_previous(ops['mfi2'],'pink','pink')
        #self.tp.plot(ops['pp_ema64'],'lime')
        self.tp.plot(ops['ksrsi']/100.0,'orange')
        self.tp.plot(ops['dsrsi']/100.0,'cyan')

        
        #self.tp.plot_check_previous(ops["changestd"],'white','white')
    ...
    def plot_sell(self,ops,index,size):
        ...
        self.tp.plot_check_previous(ops['main_dtlclose'][st:en],'white','white')
    ...
    def buy(self,ops,index):
        ...
        if( ops['main_dtlclose'][index]<ops['pp_30sma'][index]
        or ops['main_dtlclose'][index]<ops['pp_50sma'][index]
        or ops['main_dtlclose'][index]<ops['pp_100sma'][index] 
        ):
            return False    
