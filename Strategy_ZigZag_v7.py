...
class Strategy (TraderStrategy):
    ...
    def run_strategy(self):
        ...
        ops["pp_ema64"] = dtl.EMA(dtl.close,64,strip=True)
        ...
        ops["pp_kama6ema"] = hkdtl.EMA(ops["pp_kama6"],10)  
    ...
    def plot(self,ops,buy_index,sell_index):
        ...
        #self.tp.plot_check_previous(ops["f_macdline"]*0.25,'black','black')
        #self.tp.plot_check_previous(ops["f_signalline"]*0.25,'black','black')
        #self.tp.fill(ops["f_histogram"]*0.25,0,'red','green')
        ...
        #self.tp.fill(ops["pp_ema64"]-ops["pp_kama6ema"],0,'red','green')
        ...
        self.tp.plot_check_previous(ops['slp'],'cyan','blue')
    ...
    def buy(self,ops,index):
        ...
        if( ops["main_dtlclose"][index]>ops['pp_ema64'][index] 
        and ops["g_pmosignalline"][index]-ops["g_pmosignalline"][index-1]>0 
    ...
    def sell(self,ops,index,buy_index):
        ...
        diff_add2 = diff_12+diff_22+diff_32+diff_42+diff_52+diff_62
        '''
        if((ops["slp"][index]-ops["slp"][index-1])<0 or diff_add <6):
            return True
        '''
        '''
        if(ops["slp"][index]-ops["slp"][index-1]<0 or ops["g_pmosignalline"][index]-ops["g_pmosignalline"][index-1]<0):
            return True
        '''
        ...
        if(ops["g_pmosignalline"][index]-ops["g_pmosignalline"][index-1]<0  ):
            ...
            return True;
        #elif(ops["main_dtlclose"][index]<=ops["main_dtlclose"][buy_index]):
